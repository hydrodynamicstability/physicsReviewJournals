# A convenient list of selected review journals in physics, mechanics, and Earth and space sciences
...
This is the highest ranked physics review journal, according to Clarivate.  It was founded in 1929 as *The Physical Review Supplement* by the editor of the *Physical Review*, John Tate.  In 1930 it was retitled *Reviews of Modern Physics*.  At the time there was no dedicated review journal in physics in the United States or Western Europe; the closest things were overviews of entire sub-disciplines appearing in the *Bulletin of the National Research Council* (1919-1950), and the German *Jahresberichte* (annual reviews) dating back to the 19th century, which were scarcely more than abstracting services.  Instead, review papers in physics would usually appear within research journals, including *Nature*, the *Bell System Technical Journal*, and various German journals and encyclopedias (where the review article genre originated).  Edward Condon’s note to Tate in 1928 mentioned that *Physiological Reviews* (founded in 1921) and *Chemical Reviews* (founded in 1924) would be good role models for a new physics review journal (see his 1968 reminiscence [here](https://doi.org/10.1103/RevModPhys.40.876)). A useful [history](https://doi.org/10.1063/PT.3.4133) of *RMP* was offered to *Physics Today* readers in 2019 by its former colloquium editor, Anthony F. Starace.  Previously, an [account](https://doi.org/10.1002/andp.201400810) of *RMP*’s birth was published by Roberto Lalli in *Annalen der Physik*.  One observation missing from Starace's and Lalli's accounts is that *Physics-Uspekhi* pre-dates the creation of *RMP* (see below).  Since its founding, *RMP* has been APS’s only journal dedicated to review articles.
...
Third ranked is this venerable supplement to *Physics Letters*, originally considered to be section C of that journal.  It began in 1971 with the publisher North-Holland, with founding editor Maurice Jacob, who described the creation of the journal in his 1995 memoir, *In the Wings of Physics* (World Scientific).

## [Reports on Progress in Physics](https://iopscience.iop.org/journal/0034-4885)
...
Current publisher:  UFN

This is a cover-to-cover English translation for the Russian publication, *Uspekhi Fizicheskikh Nauk* (*UFN*, or *Advances in Physical Sciences*), initiated in 1958 by AIP with volume 66 of its Russian parent (itself founded in 1918).  Back then, it was called *Soviet Physics Uspekhi*, changing to its current name in 1993.  According to the journal’s website, publication of the translation journal moved to Turpion and UFN as joint partners in 1994, and then by UFN solely in 1996.  The British IOP was involved in its publication from 1994 through 2022.  

The parent journal, *UFN*, was founded primarily as a review journal, though in the beginning it also allowed original research papers, as well as Russian translations of key physics papers published in the west.  The founding editor was Petr Petrovich Lazarev, with associate editor Eduard Vladimirovich Shpol'skii joining as associate editor in volume 2.  Shpol'skii became a co-lead editor with Lazarev with volume 4, and stayed on as one of the lead editors until 1936, then becoming sole chief editor, remaining until his death in 1975.  The early history of the journal is discussed in an [article](https://doi.org/10.1070/PU1968v011n03ABEH003829) by Shpol'skii celebrating the journal's 50th anniversary, and [one](https://doi.org/10.1070/PU1999v042n01ABEH000594) by editorial manager Maria S. Aksenteva, on the occasion of the journal's 80th anniversary.  

## [Contemporary Physics](https://www.tandfonline.com/journals/tcph20)

Current publisher:  Taylor & Francis

The journal was launched in 1959 under Sir Cyril N. Hinshelwood, Nobel laureate in chemistry.  It is perhaps the only such review journal that continues to include book reviews, along with review articles.



# Specialty review journals


First let me discuss several “families” of review journals, starting with the *Annual Reviews*.
...
[Advances in Chemical Physics](https://onlinelibrary.wiley.com/series/2007) began in 1957 as a book series containing review articles, similar to the 19th-century German Jahresberichte publications.  The initial editors were Ilya Prigogine and Pieter Debye (both Nobel laureates in chemistry); later Stuart Rice was its long-serving lead editor.  Unfortunately I am not sure if this publication is ongoing; the last volume I have found was published in 2018.

From 2008-2019, Wiley also published *Advances in Acoustics and Vibration*, but since 2019, it appears to have only published an erratum and an expression of concern.
...
Current publisher:  American Geophysical Union
...
*Applied Physics Reviews* was originally a section within the AIP’s *Journal of Applied Physics*, but in 2014 it was spun out into an independent journal, with initial co-editors Bill Appleton and John Poate.

## [Chemical Physics Reviews](https://pubs.aip.org/aip/cpr)

Current publisher:  American Institute of Physics Publishing

Following the footsteps of *APR*, AIP Publishing spun up *Chemical Physics Reviews* in 2020, under founding editor Felix N. Castellano.

## [Reviews of Modern Plasma Physics](https://link.springer.com/journal/41614)
